...
const FIELD_STYLES = {
    ...
    input: "block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm",
...
export const SignUpFields = ({ setFieldValue, values = {} }) => (
    <div role="group" aria-labelledby="personal-info-legend">
        ...
        <FieldWithMic
            ...
            className="mb-4"
        >
            <SpeechButton fieldName="userName" setFieldValue={setFieldValue} />
        </FieldWithMic>
        ...
        >
            <h4 id="name-legend" className="sr-only">
                Name Information
            </h4>
        ...
        <FieldWithMic
            ...
            className="mb-4"
        >
            <SpeechButton fieldName="phone" setFieldValue={setFieldValue} />
        </FieldWithMic>
    </div>
);
...
export const ConfirmPasswordField = ({ setFieldValue }) => (
    <FieldWithMic
